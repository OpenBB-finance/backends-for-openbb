...
async def get_pdf_options():
    ...
    return [{"label": pdf["name"], "value": pdf["name"]} for pdf in SAMPLE_PDFS]
...
@register_widget(
    {
        "name": "Omni Widget with SQL input",
        "description": "A versatile omni widget that can display multiple types of content",
        "category": "General",
        "type": "omni",
        "endpoint": "omni-widget-type",
        "params": [
            {
                "paramName": "prompt",
                "language": "sql",
                "type": "text",
                "description": "Any user queries should be sent in this parameter.The prompt to send to the LLM to make queries or ask questions.",
                "label": "Prompt",
                "show": False,
            },
        ],
...
@app.post("/omni-widget-type")
async def get_omni_widget_post_type(dict=Body(...)):
    """Basic Omni Widget example showing different return types without citations"""
